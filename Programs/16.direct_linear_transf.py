...
import numpy as np
# Load images
img1 = cv2.imread("D:\Workspace (VS Code)\College\Slot-B-Computer Vision\Input\cat.jpg")
img2 = cv2.imread("D:\Workspace (VS Code)\College\Slot-B-Computer Vision\Input\cat2.jpg")
