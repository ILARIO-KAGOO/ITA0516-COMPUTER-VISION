#Design and implement a water marking technique to insert the
# watermark into the original effectively image using Open CV

import cv2

original_image = cv2.imread('D:\Workspace (VS Code)\College\Slot-B-Computer Vision\Input\cat.jpg')
watermark_image = cv2.imread("D:\Workspace (VS Code)\College\Slot-B-Computer Vision\Input\cat2.jpg", cv2.IMREAD_UNCHANGED)
