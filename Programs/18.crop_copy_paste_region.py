#Implement image cropping, copying and pasting to select a
# region of interest (ROI) from the source image using Open CV.

import cv2

# Read the source image
source_image = cv2.imread('D:\Workspace (VS Code)\College\Slot-B-Computer Vision\Input\cat.jpg')
